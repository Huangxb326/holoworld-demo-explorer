...
void main() {
    ...
    `,this.readoutLabel=this.container.querySelector(`b`),this.zoomLabel=this.container.querySelector(`em`),e.appendChild(this.container),this.camera=new Co(this.sourceCamera.fov,this.sourceCamera.aspect,this.sourceCamera.near,this.sourceCamera.far),this.camera.rotation.order=`YXZ`,this.sourceCanvas.addEventListener(`pointerdown`,this.onPointerDown),this.sourceCanvas.addEventListener(`pointermove`,this.onPointerMove),this.sourceCanvas.addEventListener(`contextmenu`,this.onContextMenu),this.sourceCanvas.addEventListener(`wheel`,this.onWheel,{passive:!1}),window.addEventListener(`pointerup`,this.onPointerUp),window.addEventListener(`blur`,this.hide)}setEnabled(e){this.enabled=e,e||this.hide()}setTarget(e){this.container.classList.toggle(`has-target`,e!==null),this.readoutLabel.textContent=e?`ENTRY · ${e} · E`:`SELECTED AREA · WHEEL`}get selectionViewport(){if(!this.enabled||!this.active)return null;let e=this.getCropViewport();return{centerNdc:new V((e.offsetX+e.cropWidth*.5)/e.fullWidth*2-1,-((e.offsetY+e.cropHeight*.5)/e.fullHeight)*2+1),halfWidthNdc:e.cropWidth/e.fullWidth,halfHeightNdc:e.cropHeight/e.fullHeight}}render(){if(!this.enabled||!this.active)return;let e=this.renderer??this.createRenderer(),t=this.getCropViewport();this.camera.position.copy(this.sourceCamera.position),this.camera.quaternion.copy(this.sourceCamera.quaternion),this.camera.up.copy(this.sourceCamera.up),this.camera.near=this.sourceCamera.near,this.camera.far=this.sourceCamera.far,this.camera.fov=this.sourceCamera.fov,this.camera.aspect=this.sourceCamera.aspect,this.camera.zoom=this.sourceCamera.zoom,this.camera.clearViewOffset(),this.camera.setViewOffset(t.fullWidth,t.fullHeight,t.offsetX,t.offsetY,t.cropWidth,t.cropHeight),e.toneMappingExposure=this.exposure(),e.render(this.scene,this.camera)}dispose(){this.sourceCanvas.removeEventListener(`pointerdown`,this.onPointerDown),this.sourceCanvas.removeEventListener(`pointermove`,this.onPointerMove),this.sourceCanvas.removeEventListener(`contextmenu`,this.onContextMenu),this.sourceCanvas.removeEventListener(`wheel`,this.onWheel),window.removeEventListener(`pointerup`,this.onPointerUp),window.removeEventListener(`blur`,this.hide),this.releaseRenderer(),this.container.remove()}onPointerDown=e=>{!this.enabled||e.button!==2||(e.preventDefault(),document.pointerLockElement===this.sourceCanvas&&document.exitPointerLock(),this.active=!0,this.container.classList.add(`is-active`),this.updatePointer(e.clientX,e.clientY),this.render())};onPointerMove=e=>{!this.enabled||!this.active||this.updatePointer(e.clientX,e.clientY)};onPointerUp=e=>{e.button===2&&this.hide()};onContextMenu=e=>{this.enabled&&e.preventDefault()};onWheel=e=>{!this.enabled||!this.active||(e.preventDefault(),this.zoom=Math.max(pd,Math.min(md,this.zoom*Math.exp(-e.deltaY*.0018))),this.zoomLabel.textContent=`${this.zoom.toFixed(1)}×`,this.render())};hide=()=>{this.active=!1,this.setTarget(null),this.container.classList.remove(`is-active`),this.releaseRenderer()};createRenderer(){let e=new bu({antialias:!0,alpha:!1,powerPreference:`high-performance`});return e.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),e.setSize(fd,fd,!1),e.outputColorSpace=Ve,e.toneMapping=4,e.shadowMap.enabled=!1,e.domElement.setAttribute(`aria-hidden`,`true`),this.container.prepend(e.domElement),this.renderer=e,e}releaseRenderer(){if(!this.renderer)return;let e=this.renderer.domElement;this.renderer.dispose(),this.renderer.forceContextLoss(),e.remove(),this.renderer=null}updatePointer(e,t){let n=this.sourceCanvas.getBoundingClientRect(),r=Math.max(n.left,Math.min(n.right,e)),i=Math.max(n.top,Math.min(n.bottom,t));this.pointerPixels.set(r-n.left,i-n.top),this.container.style.left=`${Math.max(222,Math.min(window.innerWidth-222,r))}px`,this.container.style.top=`${Math.max(222,Math.min(window.innerHeight-222,i))}px`}getCropViewport(){let e=this.sourceCanvas.getBoundingClientRect(),t=Math.max(1,e.width),n=Math.max(1,e.height),r=Math.min(t,fd/this.zoom),i=Math.min(n,fd/this.zoom);return{fullWidth:t,fullHeight:n,cropWidth:r,cropHeight:i,offsetX:Math.max(0,Math.min(t-r,this.pointerPixels.x-r*.5)),offsetY:Math.max(0,Math.min(n-i,this.pointerPixels.y-i*.5))}}},_d=class{actions;loader;loaderBar;loaderPercent;loaderStatus;buildingPins=new Map;cityPanel;cityPanelTitle;cityPanelDescription;styleSelect;pinLayer;focusBuildingCount;interiorPanel;modeLabel;motionLabel;transitionLayer;help;rendererStatus;interiorTitle;interiorArea;interiorProgram;entryPrompt;entryPromptMode;entryPromptLabel;entryPromptDetail;roomAnnouncement;roomAnnouncementTitle;roomAnnouncementMeta;scanStatus;scanStatusCount;promptLockedUntil=0;announcementTimer=null;scanStatusTimer=null;currentStyle;constructor(e,t,n={}){this.actions=t,this.currentStyle=td(n.lockedStyleId??`minecraft`);let r=n.lockedStyleId?[td(n.lockedStyleId)]:Qu;e.innerHTML=`
      <main class="experience" aria-label="HoloWorld interactive explorer">
        ...
        <div class="loading-screen" id="loading-screen">
          ...
          <h2>Assembling the style atlas</h2>
            <p id="loader-status">Preparing derived assets</p>
          </div>
    ...
    `).join(``);for(let e of this.pinLayer.querySelectorAll(`[data-building-id]`)){let n=e.dataset.buildingId,r=e.dataset.interiorId;!n||!r||(this.buildingPins.set(n,e),e.addEventListener(`click`,()=>{e.classList.contains(`is-selected`)?t.onEnter(r):t.onLocate(n)}))}}};function vd(e){return new Promise(t=>window.setTimeout(t,e))}function yd(e){return Number.isInteger(e)?e.toFixed(0):e.toFixed(1)}function bd(e){return e.replace(/[_-]+/g,` `).replace(/\s+/g,` `).trim()}function xd(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function Sd(e){let t=new Map,n=new Map,r=e.clone();return Cd(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Cd(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Cd(e.children[r],t.children[r],n)}var wd=class extends no{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Ad(e)}),this.register(function(e){return new jd(e)}),this.register(function(e){return new Bd(e)}),this.register(function(e){return new Vd(e)}),this.register(function(e){return new Hd(e)}),this.register(function(e){return new Nd(e)}),this.register(function(e){return new Pd(e)}),this.register(function(e){return new Fd(e)}),this.register(function(e){return new Id(e)}),this.register(function(e){return new kd(e)}),this.register(function(e){return new Ld(e)}),this.register(function(e){return new Md(e)}),this.register(function(e){return new zd(e)}),this.register(function(e){return new Rd(e)}),this.register(function(e){return new Dd(e)}),this.register(function(e){return new Ud(e,Y.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Ud(e,Y.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Wd(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=Mo.extractUrlBase(e);a=Mo.resolveURL(t,this.path)}else a=Mo.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new ao(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Gd){try{a[Y.KHR_BINARY_GLTF]=new Jd(e)}catch(e){r&&r(e);return}i=JSON.parse(a[Y.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new xf(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case Y.KHR_MATERIALS_UNLIT:a[t]=new Od;break;case Y.KHR_DRACO_MESH_COMPRESSION:a[t]=new Yd(i,this.dracoLoader);break;case Y.KHR_TEXTURE_TRANSFORM:a[t]=new Xd;break;case Y.KHR_MESH_QUANTIZATION:a[t]=new Zd;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function Td(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function Ed(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var Y={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},Dd=class{constructor(e){this.parser=e,this.name=Y.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new K(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],He);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Ao(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new Do(s),o.distance=c;break;case`spot`:o=new To(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),pf(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},Od=class{constructor(){this.name=Y.KHR_MATERIALS_UNLIT}getMaterialType(){return Wr}extendParams(e,t,n){let r=[];e.color=new K(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],He),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,Ve))}return Promise.all(r)}},kd=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Ad=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new V(e,e)}return Promise.all(r)}},jd=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},Md=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Nd=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_SHEEN}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new K(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],He)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,Ve)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Pd=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},Fd=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_VOLUME}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new K().setRGB(i[0],i[1],i[2],He),Promise.all(r)}},Id=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_IOR}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Ld=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new K().setRGB(i[0],i[1],i[2],He),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,Ve)),Promise.all(r)}},Rd=class{constructor(e){this.parser=e,this.name=Y.EXT_MATERIALS_BUMP}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},zd=class{constructor(e){this.parser=e,this.name=Y.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Ed(this.parser,e,this.name)===null?null:Aa}extendMaterialParams(e,t){let n=Ed(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},Bd=class{constructor(e){this.parser=e,this.name=Y.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Vd=class{constructor(e){this.parser=e,this.name=Y.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Hd=class{constructor(e){this.parser=e,this.name=Y.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Ud=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}return null}},Wd=class{constructor(e){this.name=Y.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==tf.TRIANGLES&&e.mode!==tf.TRIANGLE_STRIP&&e.mode!==tf.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new G,n=new H,a=new At,s=new H(1,1,1),c=new Oi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new bi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);Tn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Gd=`glTF`,Kd=12,qd={JSON:1313821514,BIN:5130562},Jd=class{constructor(e){this.name=Y.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,Kd),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Gd)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-Kd,i=new DataView(e,Kd),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===qd.JSON){let r=new Uint8Array(e,Kd+a,t);this.content=n.decode(r)}else if(r===qd.BIN){let n=Kd+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},Yd=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=Y.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=sf[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=sf[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=nf[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,He,n)})})}},Xd=class{constructor(){this.name=Y.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Zd=class{constructor(){this.name=Y.KHR_MESH_QUANTIZATION}},Qd=class extends La{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},$d=new At,ef=class extends Qd{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return $d.fromArray(i).normalize().toArray(i),i}},tf={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},nf={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},rf={9728:i,9729:s,9984:a,9985:c,9986:o,9987:l},af={33071:n,33648:r,10497:t},of={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},sf={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},cf={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},lf={CUBICSPLINE:void 0,LINEAR:Ie,STEP:N},uf={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function df(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new ka({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function ff(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function pf(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function mf(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function hf(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function gf(e){let t,n=e.extensions&&e.extensions[Y.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+_f(n.attributes):e.indices+`:`+_f(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+_f(e.targets[n]);return t}function _f(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function vf(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function yf(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var bf=new G,xf=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Td,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}this.textureLoader=typeof createImageBitmap>`u`||n&&r<17||i&&a<98?new co(this.options.manager):new Po(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new ao(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return ff(i,a,r),pf(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e)}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Y.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(Mo.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=of[r.type],t=nf[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new hr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=of[r.type],o=nf[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new jr(f,u/s),t.cache.add(n,c)),p=new Nr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new hr(f,a,d);if(r.sparse!==void 0){let t=of.SCALAR,n=nf[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new hr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=rf[n.magFilter]||1006,t.minFilter=rf[n.minFilter]||1008,t.wrapS=af[n.wrapS]||1e3,t.wrapT=af[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Kt(e);t.needsUpdate=!0,n(t)}),t.load(Mo.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),pf(e,a),e.userData.mimeType=a.mimeType||yf(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[Y.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[Y.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[Y.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Zi,Fr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Li,Fr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return ka}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[Y.KHR_MATERIALS_UNLIT]){let e=r[Y.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new K(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],He),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,Ve)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||uf.OPAQUE;if(l===uf.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===uf.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==Wr&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new V(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==Wr&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==Wr){let e=i.emissiveFactor;o.emissive=new K().setRGB(e[0],e[1],e[2],He)}return i.emissiveTexture!==void 0&&a!==Wr&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,Ve)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),pf(n,i),t.associations.set(n,{materials:e}),i.extensions&&ff(r,n,i),n})}createUniqueName(e){let t=Qo.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[Y.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return Cf(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=gf(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[Y.KHR_DRACO_MESH_COMPRESSION]?i(o):Cf(new Ar,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?df(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===tf.TRIANGLES||u.mode===tf.TRIANGLE_STRIP||u.mode===tf.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new mi(l,f):new ni(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===tf.TRIANGLE_STRIP?d.geometry=xd(d.geometry,1):u.mode===tf.TRIANGLE_FAN&&(d.geometry=xd(d.geometry,2));else if(u.mode===tf.LINES)d=new Yi(l,f);else if(u.mode===tf.LINE_STRIP)d=new Gi(l,f);else if(u.mode===tf.LINE_LOOP)d=new Xi(l,f);else if(u.mode===tf.POINTS)d=new na(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&hf(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),pf(d,i),u.extensions&&ff(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&ff(r,c[0],i),c[0];let l=new En;i.extensions&&ff(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Co(kt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new Oo(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),pf(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new G;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new yi(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new Xa(i,void 0,l);return pf(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,bf)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new H().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new hi:t.length>1?new En:t.length===1?t[0]:new Tn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),pf(o,i),i.extensions&&ff(n,o,i),i.matrix!==void 0){let e=new G;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new En;n.name&&(i.name=r.createUniqueName(n.name)),pf(i,n),n.extensions&&ff(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(Sd(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Fr||e instanceof Kt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}cf[i.path]===cf.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(cf[i.path]){case cf.weights:l=Ga;break;case cf.rotation:l=qa;break;case cf.translation:case cf.scale:l=Ya;break;default:switch(n.itemSize){case 1:l=Ga;break;default:l=Ya}}let u=r.interpolation===void 0?Ie:lf[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+cf[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=vf(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof qa?ef:Qd)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Sf(e,t,n){let r=t.attributes,i=new Zn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new H(t[0],t[1],t[2]),new H(a[0],a[1],a[2])),e.normalized){let t=vf(nf[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new H,t=new H;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=vf(nf[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Sr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function Cf(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=sf[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return W.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${W.workingColorSpace}" not supported.`),pf(e,t),Sf(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:mf(e,t.targets,n)})}var wf=(function(){var e=`b9H79Tebbbe8Fv9Gbb9Gvuuuuueu9Giuuub9Geueu9Giuuueuixkbeeeddddillviebeoweuecj:Gdkr;:VZkdbk:XYi5ud9:du8Jjjjjbcj;kb9Rgv8Kjjjjbc9:hodnalTmbcuhoaiRbbgrc;WeGc:Ge9hmbarcsGgwce0mbc9:hoalcufadcd4cbawEgDadfgrcKcaawEgqaraq0Egk6mbaicefhxcj;abad9Uc;WFbGcjdadca0EhmaialfgPar9Rgoadfhsavaoadz:jjjjbgzceVhHcbhOdndninaeaO9nmeaPax9RaD6mdamaeaO9RaOamfgoae6EgAcsfglc9WGhCabaOad2fhXaAcethQaxaDfhiaOaeaoaeao6E9RhLalcl4cifcd4hKazcj;cbfaAfhYcbh8AazcjdfhEaHh3incbh5dnawTmbaxa8Acd4fRbbh5kcbh8Eazcj;cbfhqinaih8Fdndndndna5a8Ecet4ciGgoc9:fPdebdkaPa8F9RaA6mrazcj;cbfa8EaA2fa8FaAz:jjjjb8Aa8FaAfhixdkazcj;cbfa8EaA2fcbaAz:kjjjb8Aa8FhixekaPa8F9RaK6mva8FaKfhidnaCTmbaPai9RcK6mbaocdtc:q:G:cjbfcj:G:cjbawEhaczhrcbhlinargoc9Wfghaqfhrdndndndndndnaaa8Fahco4fRbbalcoG4ciGcdtfydbPDbedvivvvlvkar9cb83bwar9cb83bbxlkarcbaiRbdai8Xbb9c:c:qj:bw9:9c:q;c1:I1e:d9c:b:c:e1z9:gg9cjjjjjz:dg8J9qE86bbaqaofgrcGfcbaicdfa8J9c8N1:NfghRbbag9cjjjjjw:dg8J9qE86bbarcVfcbaha8J9c8M1:NfghRbbag9cjjjjjl:dg8J9qE86bbarc7fcbaha8J9c8L1:NfghRbbag9cjjjjjd:dg8J9qE86bbarctfcbaha8J9c8K1:NfghRbbag9cjjjjje:dg8J9qE86bbarc91fcbaha8J9c8J1:NfghRbbag9cjjjj;ab:dg8J9qE86bbarc4fcbaha8J9cg1:NfghRbbag9cjjjja:dg8J9qE86bbarc93fcbaha8J9ch1:NfghRbbag9cjjjjz:dgg9qE86bbarc94fcbahag9ca1:NfghRbbai8Xbe9c:c:qj:bw9:9c:q;c1:I1e:d9c:b:c:e1z9:gg9cjjjjjz:dg8J9qE86bbarc95fcbaha8J9c8N1:NfgiRbbag9cjjjjjw:dg8J9qE86bbarc96fcbaia8J9c8M1:NfgiRbbag9cjjjjjl:dg8J9qE86bbarc97fcbaia8J9c8L1:NfgiRbbag9cjjjjjd:dg8J9qE86bbarc98fcbaia8J9c8K1:NfgiRbbag9cjjjjje:dg8J9qE86bbarc99fcbaia8J9c8J1:NfgiRbbag9cjjjj;ab:dg8J9qE86bbarc9:fcbaia8J9cg1:NfgiRbbag9cjjjja:dg8J9qE86bbarcufcbaia8J9ch1:NfgiRbbag9cjjjjz:dgg9qE86bbaiag9ca1:::;cbfhhcbh8EaEhaina8FRbbhraahocbhlinaoahalfRbbgqce4cbaqceG9R7arfgr86bbaoadfhoaAalcefgl9hmbkaacefhaa8Fcefh8FahaAfhha8Ecefg8Ecl9hmbxikkaATmeaza8Afhaazcj;cbfhhcbhoceh8EaYh8FinaEaofhlaa8Vbbhrcbhoinala8FaofRbbcwtahaofRbbgqVc;:FiGce4cbaqceG9R7arfgr87bbaladfhlaLaocefgofmbka8FaQfh8FcdhoaacdfhaahaQfhha8EceGhlcbh8EalmbxdkkaATmbaocl4h8Eaza8AfRbbhqcwhoa3hlinalRbbaotaqVhqalcefhlaocwfgoca9hmbkcbhhaEh8FaYhainazcj;cbfahfRbbhrcwhoaahlinalRbbaotarVhralaAfhlaocwfgoca9hmbkara8E94aq7hqcbhoa8Fhlinalaqao486bbalcefhlaocwfgoca9hmbka8Fadfh8FaacefhaahcefghaA9hmbkkaEclfhEa3clfh3a8Aclfg8Aad6mbkaXazcjdfaAad2z:jjjjb8AazazcjdfaAcufad2fadz:jjjjb8AaAaOfhOaihxaimbkc9:hoxdkcbc99aPax9RakSEhoxekc9:hokavcj;kbf8Kjjjjbaok:ysezu8Jjjjjbc;ae9Rgv8Kjjjjbc9:hodnalaeci9UgrcHf6mbcuhoaiRbbgwc;WeGc;Ge9hmbawcsGgDce0mbavc;abfcFecjez:kjjjb8Aav9cu83iUav9cu83i8Wav9cu83iyav9cu83iaav9cu83iKav9cu83izav9cu83iwav9cu83ibaialfc9WfhqaicefgwarfhldnaeTmbcmcsaDceSEhkcbhxcbhmcbhrcbhicbhoindnalaq9nmbc9:hoxikdndnawRbbgDc;Ve0mbavc;;abfaocitfgsaDBdbasazBdlavaicdtfaDBdbavc;;abfaocitfgHaDBdbaHaxBdlavaicefgicsGcdtfaDBdbavc;abfaocefcsGcitfgHasBdbaHaDBdlavaiazfgicsGcdtfasBdbavc;abfaocdfcsGcitfgDaxBdbaDasBdlaocifhoaiaPfhiaOaPfhxxekaxcbalRbbgsEgHaDc;:;abfaocitfgDaOBdbaDaHBdlavaicdtfaHBdbavc;abfaocefcsGcitfgDazBdbaDaOBdlavaicefgicsGcdtfaOBdbavc;abfaocdfcsGcitfgDaHBdbaDazBdlavaiaCTaCcsSVfgicsGcdtfazBdbaiaATaAcsSVfhiaocifhokawcefhwaocsGhoaicsGhiarcifgrae6mbkkcbc99alaqSEhokavc;aef8Kjjjjbaok:clevu8Jjjjjbcz9Rhvdnalaecvf9pmbc9:skdnaiRbbc;:eGc;qeSmbcuskav9cb83iwaicefhoaialfc98fhrdnaeTmbdnadcdSmbcbhwindnaoar6mbc9:skaocefhlao8SbbgicFeGhddndnaicu9mmbalhoxekaocvfhoadcFbGhdcrhidninal8SbbgDcFbGaitadVhdaDcu9kmealcefhlaicrfgic8J9hmbxdkkalcefhokabawcdtfadc8Etc8F91adcd47avcwfadceGcdtVglydbfgiBdbalaiBdbawcefgwae9hmbxdkkcbhwindnaoar6mbc9:skaocefhlao8SbbgicFeGhddndnaicu9mmbalhoxekaocvfhoadcFbGhdcrhidninal8SbbgDcFbGaitadVhdaDcu9kmealcefhlaicrfgic8J9hmbxdkkalcefhokabawcetfadc8Etc8F91adcd47avcwfadceGcdtVglydbfgi87ebalaiBdbawcefgwae9hmbkkcbc99aoarSEk:Lvoeue99dud99eud99dndnadcl9hmbaeTmeindndnabcdfgd8Sbb:Yab8Sbbgi:Ygl:l:tabcefgv8Sbbgo:Ygr:l:tgwJbb;:9cawawNJbbbbawawJbbbb9GgDEgq:mgkaqaicb9iEalMgwawNakaqaocb9iEarMgqaqNMM:r:vglNJbbbZJbbb:;aDEMgr:lJbbb9p9DTmbar:Ohixekcjjjj94hikadai86bbdndnaqalNJbbbZJbbb:;aqJbbbb9GEMgq:lJbbb9p9DTmbaq:Ohdxekcjjjj94hdkavad86bbdndnawalNJbbbZJbbb:;awJbbbb9GEMgw:lJbbb9p9DTmbaw:Ohdxekcjjjj94hdkabad86bbabclfhbaecufgembxdkkaeTmbindndnabclfgd8Ueb:Yab8Uebgi:Ygl:l:tabcdfgv8Uebgo:Ygr:l:tgwJb;:FSawawNJbbbbawawJbbbb9GgDEgq:mgkaqaicb9iEalMgwawNakaqaocb9iEarMgqaqNMM:r:vglNJbbbZJbbb:;aDEMgr:lJbbb9p9DTmbar:Ohixekcjjjj94hikadai87ebdndnaqalNJbbbZJbbb:;aqJbbbb9GEMgq:lJbbb9p9DTmbaq:Ohdxekcjjjj94hdkavad87ebdndnawalNJbbbZJbbb:;awJbbbb9GEMgw:lJbbb9p9DTmbaw:Ohdxekcjjjj94hdkabad87ebabcwfhbaecufgembkkk:4ioiue99dud99dud99dnaeTmbcbhiabhlindndnal8Uebgv:YgoJ:ji:1Salcof8UebgrciVgw:Y:vgDNJbbbZJbbb:;avcu9kEMgq:lJbbb9p9DTmbaq:Ohkxekcjjjj94hkkalclf8Uebhvalcdf8UebhxalarcefciGcetfak87ebdndnax:YgqaDNJbbbZJbbb:;axcu9kEMgm:lJbbb9p9DTmbam:Ohxxekcjjjj94hxkabaiarciGgkfcd7cetfax87ebdndnav:YgmaDNJbbbZJbbb:;avcu9kEMgP:lJbbb9p9DTmbaP:Ohvxekcjjjj94hvkalarcufciGcetfav87ebdndnawaw2:ZgPaPMaoaoN:taqaqN:tamamN:tgoJbbbbaoJbbbb9GE:raDNJbbbZMgD:lJbbb9p9DTmbaD:Ohrxekcjjjj94hrkalakcetfar87ebalcwfhlaiclfhiaecufgembkkk9mbdnadcd4ae2gdTmbinababydbgecwtcw91:Yaece91cjjj98Gcjjj;8if::NUdbabclfhbadcufgdmbkkk:Tvirud99eudndnadcl9hmbaeTmeindndnabRbbgiabcefgl8Sbbgvabcdfgo8Sbbgrf9R:YJbbuJabcifgwRbbgdce4adVgDcd4aDVgDcl4aDVgD:Z:vgqNJbbbZMgk:lJbbb9p9DTmbak:Ohxxekcjjjj94hxkaoax86bbdndnaraif:YaqNJbbbZMgk:lJbbb9p9DTmbak:Ohoxekcjjjj94hokalao86bbdndnavaifar9R:YaqNJbbbZMgk:lJbbb9p9DTmbak:Ohixekcjjjj94hikabai86bbdndnaDadcetGadceGV:ZaqNJbbbZMgq:lJbbb9p9DTmbaq:Ohdxekcjjjj94hdkawad86bbabclfhbaecufgembxdkkaeTmbindndnab8Vebgiabcdfgl8Uebgvabclfgo8Uebgrf9R:YJbFu9habcofgw8Vebgdce4adVgDcd4aDVgDcl4aDVgDcw4aDVgD:Z:vgqNJbbbZMgk:lJbbb9p9DTmbak:Ohxxekcjjjj94hxkaoax87ebdndnaraif:YaqNJbbbZMgk:lJbbb9p9DTmbak:Ohoxekcjjjj94hokalao87ebdndnavaifar9R:YaqNJbbbZMgk:lJbbb9p9DTmbak:Ohixekcjjjj94hikabai87ebdndnaDadcetGadceGV:ZaqNJbbbZMgq:lJbbb9p9DTmbaq:Ohdxekcjjjj94hdkawad87ebabcwfhbaecufgembkkk9teiucbcbyd:K:G:cjbgeabcifc98GfgbBd:K:G:cjbdndnabZbcztgd9nmbcuhiabad9RcFFifcz4nbcuSmekaehikaik;LeeeudndnaeabVciGTmbabhixekdndnadcz9pmbabhixekabhiinaiaeydbBdbaiclfaeclfydbBdbaicwfaecwfydbBdbaicxfaecxfydbBdbaeczfheaiczfhiadc9Wfgdcs0mbkkadcl6mbinaiaeydbBdbaeclfheaiclfhiadc98fgdci0mbkkdnadTmbinaiaeRbb86bbaicefhiaecefheadcufgdmbkkabk;aeedudndnabciGTmbabhixekaecFeGc:b:c:ew2hldndnadcz9pmbabhixekabhiinaialBdbaicxfalBdbaicwfalBdbaiclfalBdbaiczfhiadc9Wfgdcs0mbkkadcl6mbinaialBdbaiclfhiadc98fgdci0mbkkdnadTmbinaiae86bbaicefhiadcufgdmbkkabkk83dbcj:Gdk8Kbbbbdbbblbbbwbbbbbbbebbbdbbblbbbwbbbbc:K:Gdkl8W:qbb`,t=`b9H79TebbbeKl9Gbb9Gvuuuuueu9Giuuub9Geueuixkbbebeeddddilve9Weeeviebeoweuecj:Gdkr;:W9Dklbzik94evu8Jjjjjbcz9Rhbcbheincbhdcbhiinabcwfadfaicjuaead4ceGglE86bbaialfhiadcefgdcw9hmbkaeai86b:q:W:cjbaecitab8Piw83i:q:G:cjbaecefgecjd9hmbkk:JBl8Aud97dur978Jjjjjbcj;kb9Rgv8Kjjjjbc9:hodnalTmbcuhoaiRbbgrc;WeGc:Ge9hmbarcsGgwce0mbc9:hoalcufadcd4cbawEgDadfgrcKcaawEgqaraq0Egk6mbaialfgxar9RhodnadTgmmbavaoad;8qbbkaicefhPcj;abad9Uc;WFbGcjdadca0EhsdndndnadTmbaoadfhzcbhHinaeaH9nmdaxaP9RaD6miabaHad2fhOaPaDfhAasaeaH9RaHasfae6EgCcsfgocl4cifcd4hXavcj;cbfaoc9WGgQcetfhLavcj;cbfaQci2fhKavcj;cbfaQfhYcbh8Aaoc;ab6hEincbh3dnawTmbaPa8Acd4fRbbh3kcbh5avcj;cbfh8Eindndndndna3a5cet4ciGgoc9:fPdebdkaxaA9RaQ6mwdnaQTmbavcj;cbfa5aQ2faAaQ;8qbbkaAaCfhAxdkaQTmeavcj;cbfa5aQ2fcbaQ;8kbxekaxaA9RaX6moaoclVcbawEhraAaXfhocbhidnaEmbaxao9Rc;Gb6mbcbhlina8EalfhidndndndndndnaAalco4fRbbgqciGarfPDbedibledibkaipxbbbbbbbbbbbbbbbbpklbxlkaiaopbblaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLg8Fcdp:mea8FpmbzeHdOiAlCvXoQrLpxiiiiiiiiiiiiiiiip9ogapxiiiiiiiiiiiiiiiip8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbahaoclffagRb:q:W:cjbfhoxikaiaopbbwaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLpxssssssssssssssssp9ogapxssssssssssssssssp8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbahaocwffagRb:q:W:cjbfhoxdkaiaopbbbpklbaoczfhoxekaiaopbbdaoRbbghcitpbi:q:G:cjbahRb:q:W:cjbghpsaoRbeggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPpklbahaocdffagRb:q:W:cjbfhokdndndndndndnaqcd4ciGarfPDbedibledibkaiczfpxbbbbbbbbbbbbbbbbpklbxlkaiczfaopbblaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLg8Fcdp:mea8FpmbzeHdOiAlCvXoQrLpxiiiiiiiiiiiiiiiip9ogapxiiiiiiiiiiiiiiiip8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbahaoclffagRb:q:W:cjbfhoxikaiczfaopbbwaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLpxssssssssssssssssp9ogapxssssssssssssssssp8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbahaocwffagRb:q:W:cjbfhoxdkaiczfaopbbbpklbaoczfhoxekaiczfaopbbdaoRbbghcitpbi:q:G:cjbahRb:q:W:cjbghpsaoRbeggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPpklbahaocdffagRb:q:W:cjbfhokdndndndndndnaqcl4ciGarfPDbedibledibkaicafpxbbbbbbbbbbbbbbbbpklbxlkaicafaopbblaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLg8Fcdp:mea8FpmbzeHdOiAlCvXoQrLpxiiiiiiiiiiiiiiiip9ogapxiiiiiiiiiiiiiiiip8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbahaoclffagRb:q:W:cjbfhoxikaicafaopbbwaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLpxssssssssssssssssp9ogapxssssssssssssssssp8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbahaocwffagRb:q:W:cjbfhoxdkaicafaopbbbpklbaoczfhoxekaicafaopbbdaoRbbghcitpbi:q:G:cjbahRb:q:W:cjbghpsaoRbeggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPpklbahaocdffagRb:q:W:cjbfhokdndndndndndnaqco4arfPDbedibledibkaic8Wfpxbbbbbbbbbbbbbbbbpklbxlkaic8Wfaopbblaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLg8Fcdp:mea8FpmbzeHdOiAlCvXoQrLpxiiiiiiiiiiiiiiiip9ogapxiiiiiiiiiiiiiiiip8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Ngicitpbi:q:G:cjbaiRb:q:W:cjbgipsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Ngqcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbaiaoclffaqRb:q:W:cjbfhoxikaic8Wfaopbbwaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLpxssssssssssssssssp9ogapxssssssssssssssssp8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Ngicitpbi:q:G:cjbaiRb:q:W:cjbgipsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Ngqcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spklbaiaocwffaqRb:q:W:cjbfhoxdkaic8Wfaopbbbpklbaoczfhoxekaic8WfaopbbdaoRbbgicitpbi:q:G:cjbaiRb:q:W:cjbgipsaoRbegqcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPpklbaiaocdffaqRb:q:W:cjbfhokalc;abfhialcjefaQ0meaihlaxao9Rc;Fb0mbkkdnaiaQ9pmbaici4hlinaxao9RcK6mwa8EaifhqdndndndndndnaAaico4fRbbalcoG4ciGarfPDbedibledibkaqpxbbbbbbbbbbbbbbbbpkbbxlkaqaopbblaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLg8Fcdp:mea8FpmbzeHdOiAlCvXoQrLpxiiiiiiiiiiiiiiiip9ogapxiiiiiiiiiiiiiiiip8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spkbbahaoclffagRb:q:W:cjbfhoxikaqaopbbwaopbbbg8Fclp:mea8FpmbzeHdOiAlCvXoQrLpxssssssssssssssssp9ogapxssssssssssssssssp8Jg8Fp5b9cjF;8;4;W;G;ab9:9cU1:Nghcitpbi:q:G:cjbahRb:q:W:cjbghpsa8Fp5e9cjF;8;4;W;G;ab9:9cU1:Nggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPaaa8Fp9spkbbahaocwffagRb:q:W:cjbfhoxdkaqaopbbbpkbbaoczfhoxekaqaopbbdaoRbbghcitpbi:q:G:cjbahRb:q:W:cjbghpsaoRbeggcitpbi:q:G:cjbp9UpmbedilvorzHOACXQLpPpkbbahaocdffagRb:q:W:cjbfhokalcdfhlaiczfgiaQ6mbkkaohAaoTmoka8EaQfh8Ea5cefg5cl9hmbkdndndndnawTmbaza8Acd4fRbbglciGPlbedwbkaQTmdavcjdfa8Afhlava8Afpbdbh8Jcbhoinalavcj;;cbfaofpblbg8KaYaofpblbg8LpmbzeHdOiAlCvXoQrLg8MaLaofpblbg8NaKaofpblbgypmbzeHdOiAlCvXoQrLg8PpmbezHdiOAlvCXorQLg8Fcep:nea8Fpxebebebebebebebebgap9op:bep9rg8Fa8Jp:oeg8Jp9Abbbaladfgla8Ja8Fa8Fpmlvorlvorlvorlvorp:oeg8Jp9Abbbaladfgla8Ja8Fa8FpmwDqkwDqkwDqkwDqkp:oeg8Jp9Abbbaladfgla8Ja8Fa8FpmxmPsxmPsxmPsxmPsp:oeg8Jp9Abbbaladfgla8Ja8Ma8PpmwDKYqk8AExm35Ps8E8Fg8Fcep:nea8Faap9op:bep9rg8Fp:oeg8Jp9Abbbaladfgla8Ja8Fa8Fpmlvorlvorlvorlvorp:oeg8Jp9Abbbaladfgla8Ja8Fa8FpmwDqkwDqkwDqkwDqkp:oeg8Jp9Abbbaladfgla8Ja8Fa8FpmxmPsxmPsxmPsxmPsp:oeg8Jp9Abbbaladfgla8Ja8Ka8LpmwKDYq8AkEx3m5P8Es8Fg8Ka8NaypmwKDYq8AkEx3m5P8Es8Fg8LpmbezHdiOAlvCXorQLg8Fcep:nea8Faap9op:bep9rg8Fp:oeg8Jp9Abbbaladfgla8Ja8Fa8Fpmlvorlvorlvorlvorp:oeg8Jp9Abbbaladfgla8Ja8Fa8FpmwDqkwDqkwDqkwDqkp:oeg8Jp9Abbbaladfgla8Ja8Fa8FpmxmPsxmPsxmPsxmPsp:oeg8Jp9Abbbaladfgla8Ja8Ka8LpmwDKYqk8AExm35Ps8E8Fg8Fcep:nea8Faap9op:bep9rg8Fp:oegap9Abbbaladfglaaa8Fa8Fpmlvorlvorlvorlvorp:oegap9Abbbaladfglaaa8Fa8FpmwDqkwDqkwDqkwDqkp:oegap9Abbbaladfglaaa8Fa8FpmxmPsxmPsxmPsxmPsp:oeg8Jp9AbbbaladfhlaoczfgoaQ6mbxdkkaQTmbcbhocbalcl4gl9Rc8FGhiavcjdfa8Afhrava8Afpbdbhainaravcj;cbfaofpblbg8JaYaofpblbg8KpmbzeHdOiAlCvXoQrLg8LaLaofpblbg8MaKaofpblbg8NpmbzeHdOiAlCvXoQrLgypmbezHdiOAlvCXorQLg8Faip:Rea8Falp:Tep9qg8Faap9rgap9Abbbaradfgraaa8Fa8Fpmlvorlvorlvorlvorp9rgap9Abbbaradfgraaa8Fa8FpmwDqkwDqkwDqkwDqkp9rgap9Abbbaradfgraaa8Fa8FpmxmPsxmPsxmPsxmPsp9rgap9Abbbaradfgraaa8LaypmwDKYqk8AExm35Ps8E8Fg8Faip:Rea8Falp:Tep9qg8Fp9rgap9Abbbaradfgraaa8Fa8Fpmlvorlvorlvorlvorp9rgap9Abbbaradfgraaa8Fa8FpmwDqkwDqkwDqkwDqkp9rgap9Abbbaradfgraaa8Fa8FpmxmPsxmPsxmPsxmPsp9rgap9Abbbaradfgraaa8Ja8KpmwKDYq8AkEx3m5P8Es8Fg8Ja8Ma8NpmwKDYq8AkEx3m5P8Es8Fg8KpmbezHdiOAlvCXorQLg8Faip:Rea8Falp:Tep9qg8Fp9rgap9Abbbaradfgraaa8Fa8Fpmlvorlvorlvorlvorp9rgap9Abbbaradfgraaa8Fa8FpmwDqkwDqkwDqkwDqkp9rgap9Abbbaradfgraaa8Fa8FpmxmPsxmPsxmPsxmPsp9rgap9Abbbaradfgraaa8Ja8KpmwDKYqk8AExm35Ps8E8Fg8Faip:Rea8Falp:Tep9qg8Fp9rgap9Abbbaradfgraaa8Fa8Fpmlvorlvorlvorlvorp9rgap9Abbbaradfgraaa8Fa8FpmwDqkwDqkwDqkwDqkp9rgap9Abbbaradfgraaa8Fa8FpmxmPsxmPsxmPsxmPsp9rgap9AbbbaradfhraoczfgoaQ6mbkka8Aclfg8Aad6mbkdnaCad2goTmbaOavcjdfao;8qbbkdnammbavavcjdfaCcufad2fad;8qbbkaCaHfhHc9:hoaAhPaAmbxlkkaeTmbaDalfhrcbhocuhlinaralaD9RglfaD6mdasaeao9Raoasfae6Eaofgoae6mbkaial9RhPkcbc99axaP9RakSEhoxekc9:hokavcj;kbf8Kjjjjbaokwbz:bjjjbkNsezu8Jjjjjbc;ae9Rgv8Kjjjjbc9:hodnalaeci9UgrcHf6mbcuhoaiRbbgwc;WeGc;Ge9hmbawcsGgDce0mbavc;abfcFecje;8kbav9cu83iUav9cu83i8Wav9cu83iyav9cu83iaav9cu83iKav9cu83izav9cu83iwav9cu83ibaialfc9WfhqaicefgwarfhldnaeTmbcmcsaDceSEhkcbhxcbhmcbhrcbhicbhoindnalaq9nmbc9:hoxikdndnawRbbgDc;Ve0mbavc;;abfaocitfgsaDBdbasazBdlavaicdtfaDBdbavc;;abfaocitfgHaDBdbaHaxBdlavaicefgicsGcdtfaDBdbavc;abfaocefcsGcitfgHasBdbaHaDBdlavaiazfgicsGcdtfasBdbavc;abfaocdfcsGcitfgDaxBdbaDasBdlaocifhoaiaPfhiaOaPfhxxekaxcbalRbbgsEgHaDc;:;abfaocitfgDaOBdbaDaHBdlavaicdtfaHBdbavc;abfaocefcsGcitfgDazBdbaDaOBdlavaicefgicsGcdtfaOBdbavc;abfaocdfcsGcitfgDaHBdbaDazBdlavaiaCTaCcsSVfgicsGcdtfazBdbaiaATaAcsSVfhiaocifhokawcefhwaocsGhoaicsGhiarcifgrae6mbkkcbc99alaqSEhokavc;aef8Kjjjjbaok:clevu8Jjjjjbcz9Rhvdnalaecvf9pmbc9:skdnaiRbbc;:eGc;qeSmbcuskav9cb83iwaicefhoaialfc98fhrdnaeTmbdnadcdSmbcbhwindnaoar6mbc9:skaocefhlao8SbbgicFeGhddndnaicu9mmbalhoxekaocvfhoadcFbGhdcrhidninal8SbbgDcFbGaitadVhdaDcu9kmealcefhlaicrfgic8J9hmbxdkkalcefhokabawcdtfadc8Etc8F91adcd47avcwfadceGcdtVglydbfgiBdbalaiBdbawcefgwae9hmbxdkkcbhwindnaoar6mbc9:skaocefhlao8SbbgicFeGhddndnaicu9mmbalhoxekaocvfhoadcFbGhdcrhidninal8SbbgDcFbGaitadVhdaDcu9kmealcefhlaicrfgic8J9hmbxdkkalcefhokabawcetfadc8Etc8F91adcd47avcwfadceGcdtVglydbfgi87ebalaiBdbawcefgwae9hmbkkcbc99aoarSEk;Toio97eue97aec98Ghedndnadcl9hmbaeTmecbhdinababpbbbgicKp:RecKp:Sep;6eglaicwp:RecKp:Sep;6ealp;Geaiczp:RecKp:Sep;6egvp;Gep;Kep;Legopxbbbbbbbbbbbbbbbbp:2egralpxbbbjbbbjbbbjbbbjgwp9op9rp;Keglpxbb;:9cbb;:9cbb;:9cbb;:9calalp;Meaoaop;Meavaravawp9op9rp;Keglalp;Mep;Kep;Kep;Jep;Negvp;Mepxbbn0bbn0bbn0bbn0grp;KepxFbbbFbbbFbbbFbbbp9oaipxbbbFbbbFbbbFbbbFp9op9qalavp;Mearp;Kecwp:RepxbFbbbFbbbFbbbFbbp9op9qaoavp;Mearp;Keczp:RepxbbFbbbFbbbFbbbFbp9op9qpkbbabczfhbadclfgdae6mbxdkkaeTmbcbhdinabczfgDaDpbbbgipxbbbbbbFFbbbbbbFFgwp9oabpbbbgoaipmbediwDqkzHOAKY8AEgvczp:Reczp:Sep;6eglaoaipmlvorxmPsCXQL358E8FpxFubbFubbFubbFubbp9op;6eavczp:Sep;6egvp;Gealp;Gep;Kep;Legipxbbbbbbbbbbbbbbbbp:2egralpxbbbjbbbjbbbjbbbjgqp9op9rp;Keglpxb;:FSb;:FSb;:FSb;:FSalalp;Meaiaip;Meavaravaqp9op9rp;Keglalp;Mep;Kep;Kep;Jep;Negvp;Mepxbbn0bbn0bbn0bbn0grp;KepxFFbbFFbbFFbbFFbbp9oaiavp;Mearp;Keczp:Rep9qgialavp;Mearp;KepxFFbbFFbbFFbbFFbbp9oglpmwDKYqk8AExm35Ps8E8Fp9qpkbbabaoawp9oaialpmbezHdiOAlvCXorQLp9qpkbbabcafhbadclfgdae6mbkkk;2ileue97euo97dnaec98GgiTmbcbheinabcKfpx:ji:1S:ji:1S:ji:1S:ji:1SabpbbbglabczfgvpbbbgopmlvorxmPsCXQL358E8Fgrczp:Segwpxibbbibbbibbbibbbp9qp;6egDp;NegqaDaDp;MegDaDp;KealaopmbediwDqkzHOAKY8AEgDczp:Reczp:Sep;6eglalp;MeaDczp:Sep;6egoaop;Mearczp:Reczp:Sep;6egrarp;Mep;Kep;Kep;Lepxbbbbbbbbbbbbbbbbp:4ep;Jep;Mepxbbn0bbn0bbn0bbn0gDp;KepxFFbbFFbbFFbbFFbbgkp9oaqaop;MeaDp;Keczp:Rep9qgoaqalp;MeaDp;Keakp9oaqarp;MeaDp;Keczp:Rep9qgDpmwDKYqk8AExm35Ps8E8Fglp5eawclp:RegqpEi:T:j83ibavalp5baqpEd:T:j83ibabcwfaoaDpmbezHdiOAlvCXorQLgDp5eaqpEe:T:j83ibabaDp5baqpEb:T:j83ibabcafhbaeclfgeai6mbkkkuee97dnadcd4ae2c98GgeTmbcbhdinababpbbbgicwp:Recwp:Sep;6eaicep:SepxbbjFbbjFbbjFbbjFp9opxbbjZbbjZbbjZbbjZp:Uep;Mepkbbabczfhbadclfgdae6mbkkk:Sodw97euaec98Ghedndnadcl9hmbaeTmecbhdinabpxbbuJbbuJbbuJbbuJabpbbbgicKp:TeglaicYp:Tep9qgvcdp:Teavp9qgvclp:Teavp9qgop;6ep;Negvaicwp:RecKp:SegraipxFbbbFbbbFbbbFbbbgwp9ogDp:Uep;6ep;Mepxbbn0bbn0bbn0bbn0gqp;Kecwp:RepxbFbbbFbbbFbbbFbbp9oavaDarp:Xeaiczp:RecKp:Segip:Uep;6ep;Meaqp;Keawp9op9qavaDaraip:Uep:Xep;6ep;Meaqp;Keczp:RepxbbFbbbFbbbFbbbFbp9op9qavaoalcep:Rep9oalpxebbbebbbebbbebbbp9op9qp;6ep;Meaqp;KecKp:Rep9qpkbbabczfhbadclfgdae6mbxdkkaeTmbcbhdinabczfgkpxbFu9hbFu9hbFu9hbFu9habpbbbglakpbbbgrpmlvorxmPsCXQL358E8Fgvczp:TegqavcHp:Tep9qgicdp:Teaip9qgiclp:Teaip9qgicwp:Teaip9qgop;6ep;NegialarpmbediwDqkzHOAKY8AEgDpxFFbbFFbbFFbbFFbbglp9ograDczp:Segwp:Ueavczp:Reczp:SegDp:Xep;6ep;Mepxbbn0bbn0bbn0bbn0gvp;Kealp9oaiarawaDp:Uep:Xep;6ep;Meavp;Keczp:Rep9qgwaiaoaqcep:Rep9oaqpxebbbebbbebbbebbbp9op9qp;6ep;Meavp;Keczp:ReaiaDarp:Uep;6ep;Meavp;Kealp9op9qgipmwDKYqk8AExm35Ps8E8FpkbbabawaipmbezHdiOAlvCXorQLpkbbabcafhbadclfgdae6mbkkk9teiucbcbydj:G:cjbgeabcifc98GfgbBdj:G:cjbdndnabZbcztgd9nmbcuhiabad9RcFFifcz4nbcuSmekaehikaikkxebcj:Gdklz:zbb`,n=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,3,2,0,0,5,3,1,0,1,12,1,0,10,22,2,12,0,65,0,65,0,65,0,252,10,0,0,11,7,0,65,0,253,15,26,11]),r=new Uint8Array([32,0,65,2,1,106,34,33,3,128,11,4,13,64,6,253,10,7,15,116,127,5,8,12,40,16,19,54,20,9,27,255,113,17,42,67,24,23,146,148,18,14,22,45,70,69,56,114,101,21,25,63,75,136,108,28,118,29,73,115]);if(typeof WebAssembly!=`object`)return{supported:!1};var i=WebAssembly.validate(n)?s(t):s(e),a,o=WebAssembly.instantiate(i,{}).then(function(e){a=e.instance,a.exports.__wasm_call_ctors()});function s(e){for(var t=new Uint8Array(e.length),n=0;n<e.length;++n){var i=e.charCodeAt(n);t[n]=i>96?i-97:i>64?i-39:i+4}for(var a=0,n=0;n<e.length;++n)t[a++]=t[n]<60?r[t[n]]:(t[n]-60)*64+t[++n];return t.buffer.slice(0,a)}function c(e,t,n,r,i,a,o){var s=e.exports.sbrk,c=r+3&-4,l=s(c*i),u=s(a.length),d=new Uint8Array(e.exports.memory.buffer);d.set(a,u);var f=t(l,r,i,u,a.length);if(f==0&&o&&o(l,c,i),n.set(d.subarray(l,l+r*i)),s(l-s(0)),f!=0)throw Error(`Malformed buffer data: `+f)}var l={NONE:``,OCTAHEDRAL:`meshopt_decodeFilterOct`,QUATERNION:`meshopt_decodeFilterQuat`,EXPONENTIAL:`meshopt_decodeFilterExp`,COLOR:`meshopt_decodeFilterColor`},u={ATTRIBUTES:`meshopt_decodeVertexBuffer`,TRIANGLES:`meshopt_decodeIndexBuffer`,INDICES:`meshopt_decodeIndexSequence`},d=[],f=0;function p(e){var t={object:new Worker(e),pending:0,requests:{}};return t.object.onmessage=function(e){var n=e.data;t.pending-=n.count,t.requests[n.id][n.action](n.value),delete t.requests[n.id]},t}function m(e){for(var t=`self.ready = WebAssembly.instantiate(new Uint8Array([`+new Uint8Array(i)+`]), {}).then(function(result) { result.instance.exports.__wasm_call_ctors(); return result.instance; });self.onmessage = `+g.name+`;`+c.toString()+g.toString(),n=new Blob([t],{type:`text/javascript`}),r=URL.createObjectURL(n),a=d.length;a<e;++a)d[a]=p(r);for(var a=e;a<d.length;++a)d[a].object.postMessage({});d.length=e,URL.revokeObjectURL(r)}function h(e,t,n,r,i){for(var a=d[0],o=1;o<d.length;++o)d[o].pending<a.pending&&(a=d[o]);return new Promise(function(o,s){var c=new Uint8Array(n),l=++f;a.pending+=e,a.requests[l]={resolve:o,reject:s},a.object.postMessage({id:l,count:e,size:t,source:c,mode:r,filter:i},[c.buffer])})}function g(e){var t=e.data;self.ready.then(function(e){if(!t.id)return self.close();try{var n=new Uint8Array(t.count*t.size);c(e,e.exports[t.mode],n,t.count,t.size,t.source,e.exports[t.filter]),self.postMessage({id:t.id,count:t.count,action:`resolve`,value:n},[n.buffer])}catch(e){self.postMessage({id:t.id,count:t.count,action:`reject`,value:e})}})}return{ready:o,supported:!0,useWorkers:function(e){m(e)},decodeVertexBuffer:function(e,t,n,r,i){c(a,a.exports.meshopt_decodeVertexBuffer,e,t,n,r,a.exports[l[i]])},decodeIndexBuffer:function(e,t,n,r){c(a,a.exports.meshopt_decodeIndexBuffer,e,t,n,r)},decodeIndexSequence:function(e,t,n,r){c(a,a.exports.meshopt_decodeIndexSequence,e,t,n,r)},decodeGltfBuffer:function(e,t,n,r,i,o){c(a,a.exports[u[i]],e,t,n,r,a.exports[l[o]])},decodeGltfBufferAsync:function(e,t,n,r,i){return d.length>0?h(e,t,n,u[r],l[i]):o.then(function(){var o=new Uint8Array(e*t);return c(a,a.exports[u[r]],o,e,t,n,a.exports[l[i]]),o})}}})();function Tf(){return new wd().setMeshoptDecoder(wf)}var Ef=class{scene=new In;hotspots=[];raycaster=new es;hemisphere=new uo;sun=new Ao;nightSky=Af();ground;walkMap=null;walkMapMetadata=null;model=null;activeStyle;loadGeneration=0;constructor(e=ed){this.activeStyle=td(e),this.scene.add(this.hemisphere,this.sun,this.nightSky),this.ground=new ni(new ga(900,900),new ka({roughness:1,metalness:0})),this.ground.rotation.x=-Math.PI/2,this.ground.position.y=-.12,this.ground.receiveShadow=!0,this.scene.add(this.ground),this.configureAtmosphere(this.activeStyle)}get style(){return this.activeStyle}get buildings(){return this.activeStyle.buildings}get movementArea(){return this.activeStyle.movementArea}async load(e){await this.selectStyle(this.activeStyle.id,e)}async selectStyle(e,t){let n=++this.loadGeneration,r=td(e);this.clearStyleContent(),this.activeStyle=r,this.configureAtmosphere(r),this.walkMap=null,this.walkMapMetadata=null;for(let e of r.buildings)this.addHotspot(e);let i=Tf(),a=new URL(r.asset,document.baseURI).href,o=this.loadWalkMap(r),s=Promise.all(this.hotspots.map(e=>this.loadHighlight(i,e))),c=await i.loadAsync(a,e=>{t((e.total>0?e.loaded/e.total:Math.min(.94,e.loaded/12e6))*.9,`Loading ${r.shortLabel} city`)});if(n!==this.loadGeneration){Mf(c.scene);return}await Promise.all([o,s]),this.model=c.scene,this.model.name=`${r.id}-whole-city`,this.model.scale.setScalar(r.scale),this.model.traverse(e=>{if(!(e instanceof ni))return;e.castShadow=!1,e.receiveShadow=!0;let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)e instanceof ka&&e.map&&(e.map.colorSpace=Ve,e.map.anisotropy=4),r.id===`cyberpunk`&&kf(e)}),this.scene.add(this.model),t(1,`${r.shortLabel} city ready`)}sampleWalkSurface(e,t,n,r=!1){let i=this.walkMapMetadata,a=this.walkMap;if(!i||!a)return null;let o=Math.round((e-i.minX)/i.cellSize),s=Math.round((t-i.minZ)/i.cellSize),c=[];for(let e=0;e<=1&&c.length===0;e+=1)for(let t=-e;t<=e;t+=1)for(let n=-e;n<=e;n+=1){let e=o+n,r=s+t;if(e<0||e>=i.width||r<0||r>=i.depth)continue;let l=i.heightLayers??1,u=(r*i.width+e)*l;for(let e=0;e<l;e+=1){let t=a[u+e];t!==i.noData&&c.push(t)}}return r?id(c,n):rd(c,n)}measureWalkOpenness(e,t){if(!this.model)return 0;let n=this.sampleWalkSurface(e,t,0,!0);if(n===null)return 0;let r=new H(e,n+this.movementArea.eyeHeight*.72,t),i=0;for(let e=0;e<8;e+=1){let t=e*Math.PI/4;this.raycaster.set(r,new H(Math.sin(t),0,Math.cos(t))),this.raycaster.near=.3,this.raycaster.far=18,i+=this.raycaster.intersectObject(this.model,!0)[0]?.distance??18}return i}setSelected(e){for(let t of this.hotspots)t.highlight.visible=t.building.id===e}raycast(e,t,n=38){this.raycaster.setFromCamera(e,t);let r=this.raycaster.intersectObjects(this.hotspots.map(e=>e.hitMesh),!1);for(let e of r){let r=this.hotspots.find(t=>t.hitMesh===e.object)?.building;if(r&&r.bounds.distanceToPoint(t.position)<=n)return r}return null}findTargetedBuilding(e,t=38){return this.raycast(new V(0,0),e,t)}findMagnifiedBuilding(e,t,n,r){let i=null;for(let a of this.hotspots){let o=Df(a.building.bounds,e,t,n,r);if(o===null)continue;let s=a.building.bounds.distanceToPoint(e.position);(!i||o<i.score-1e-4||Math.abs(o-i.score)<=1e-4&&s<i.distance)&&(i={building:a.building,score:o,distance:s})}return i?.building??null}update(e){for(let t of this.hotspots){let n=t.highlight.getObjectByName(`procedural-portal-beacon`);n&&(n.rotation.y=e*.55)}}getFocusPose(e){let t=this.buildings.find(t=>t.id===e)??this.buildings[0],n=t.bounds.getCenter(new H);return{position:new H(t.bounds.max.x+12,t.bounds.max.y+8,t.bounds.max.z+12),target:n}}getBounds(){return this.model?new Zn().setFromObject(this.model):new Zn}configureAtmosphere(e){this.scene.background=new K(e.background),this.scene.fog=new Pn(e.fog,e.fogDensity),this.hemisphere.color.setHex(e.hemisphereSky),this.hemisphere.groundColor.setHex(e.hemisphereGround),this.hemisphere.intensity=e.hemisphereIntensity,this.sun.color.setHex(e.sunColor),this.sun.intensity=e.sunIntensity,this.sun.position.set(...e.sunPosition),this.nightSky.visible=e.id===`cyberpunk`,this.ground.visible=e.id!==`cyberpunk`;let t=this.ground.material;t instanceof ka&&t.color.setHex(e.ground)}clearStyleContent(){this.model&&=(this.scene.remove(this.model),Mf(this.model),null);for(let e of this.hotspots)this.scene.remove(e.group),Mf(e.group);this.hotspots.length=0}async loadWalkMap(e){let t=new URL(e.navigationMetadata,document.baseURI),n=await fetch(t);if(!n.ok)throw Error(`${e.shortLabel} walk map metadata failed: ${n.status}`);let r=await n.json(),i=new URL(r.data,t),a=await fetch(i);if(!a.ok)throw Error(`${e.shortLabel} walk map data failed: ${a.status}`);let o=new Float32Array(await a.arrayBuffer());if(o.length!==r.width*r.depth*(r.heightLayers??1))throw Error(`${e.shortLabel} walk map dimensions do not match data`);this.walkMapMetadata=r,this.walkMap=o}async loadHighlight(e,t){let n=t.building;if(!n.highlightAsset||!n.placement){t.highlight.add(jf(n));return}let r=await e.loadAsync(new URL(n.highlightAsset,document.baseURI).href),i=new En;i.matrix.copy(n.placement),i.matrixAutoUpdate=!1,r.scene.traverse(e=>{e instanceof ni&&(e.material=new Wr({color:16761415,transparent:!0,opacity:.48,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-2,blending:2,toneMapped:!1}),e.renderOrder=4)}),i.add(r.scene),t.highlight.add(i)}addHotspot(e){let t=new En,n=e.bounds.getSize(new H),r=e.bounds.getCenter(new H),i=new ni(new la(n.x,n.y,n.z),new Wr({color:16765286,transparent:!0,opacity:0,depthWrite:!1}));i.position.copy(r),i.name=e.id,t.add(i);let a=new En;a.name=`${e.id}-highlight`,a.scale.setScalar(e.highlightScale),a.visible=!1,t.add(a),this.scene.add(t),this.hotspots.push({building:e,group:t,hitMesh:i,highlight:a})}};function Df(e,t,n,r,i){if(r<=0||i<=0)return null;let a=1/0,o=-1/0,s=1/0,c=-1/0,l=0,u=new H;for(let n of[e.min.x,e.max.x])for(let r of[e.min.y,e.max.y])for(let i of[e.min.z,e.max.z])u.set(n,r,i).project(t),!(u.z<-1||u.z>1)&&(l+=1,a=Math.min(a,u.x),o=Math.max(o,u.x),s=Math.min(s,u.y),c=Math.max(c,u.y));if(l===0)return null;let d=Math.max(a,Math.min(o,n.x)),f=Math.max(s,Math.min(c,n.y)),p=(d-n.x)/r,m=(f-n.y)/i,h=p*p+m*m;if(h>1)return null;let g=(a+o)*.5,_=(s+c)*.5,v=(g-n.x)/r,y=(_-n.y)/i;return h+(v*v+y*y)*.001}var Of=new K(.95,1.02,1.08);function kf(e){if(e instanceof ka){e.color.multiply(Of),e.emissiveMap?(e.emissive.setHex(16777215),e.emissiveIntensity=5.6):(e.emissive.setHex(0),e.emissiveIntensity=0),e.metalness=Math.max(e.metalness,.12),e.roughness=Math.min(e.roughness,.72),e.needsUpdate=!0;return}e instanceof Wr&&(e.color.multiply(Of),e.needsUpdate=!0)}function Af(){let e=new En;e.name=`cyberpunk-night-sky`;let t=new ni(new _a(760,48,24),new Da({side:1,depthWrite:!1,fog:!1,toneMapped:!1,vertexShader:`
      ...
      `}));t.renderOrder=-10,e.add(t);let n=[],r=5370206,i=()=>(r=Math.imul(r,1664525)+1013904223>>>0,r/4294967296);for(let e=0;e<720;e+=1){let e=i()*Math.PI*2,t=i()*2-1,r=Math.sqrt(1-t*t),a=690+i()*40;n.push(a*r*Math.cos(e),a*t,a*r*Math.sin(e))}let a=new Ar;a.setAttribute(`position`,new vr(n,3));let o=new na(a,new Zi({color:12114431,size:1.55,sizeAttenuation:!0,transparent:!0,opacity:.82,depthWrite:!1,fog:!1,toneMapped:!1}));return o.name=`cyberpunk-night-stars`,o.renderOrder=-9,e.add(o),e.visible=!1,e}function jf(e){let t=new En;t.name=`procedural-portal-beacon`;let n=e.bounds.getCenter(new H),r=new ni(new ua(2.2,4.8,28,24,1,!0),new Wr({color:16765286,transparent:!0,opacity:.2,depthWrite:!1,blending:2}));r.position.set(n.x,14,n.z),t.add(r);let i=new ni(new va(7,.42,10,48),new Wr({color:16765286,transparent:!0,opacity:.92,toneMapped:!1}));i.rotation.x=Math.PI/2,i.position.set(n.x,1.2,n.z),t.add(i);let a=new Yi(new ha(new la(16,24,16)),new Li({color:16765286,transparent:!0,opacity:.62,toneMapped:!1}));return a.position.set(n.x,12,n.z),t.add(a),t}function Mf(e){e.traverse(e=>{if(!(e instanceof ni)&&!(e instanceof Yi))return;e.geometry.dispose();let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)Nf(e)})}function Nf(e){let t=e;for(let e of Object.values(t))e instanceof Kt&&e.dispose();e.dispose()}var Pf=class{rooms=new Map;pending=new Map;activeId=null;get scene(){return this.active.scene}get obstacles(){return this.active.obstacles}get movementArea(){return this.active.movementArea}get spawnPosition(){return this.active.spawnPosition}get spawnTarget(){return this.active.spawnTarget}get summary(){let{definition:e,metadata:t}=this.active;return{id:e.id,styleId:e.styleId,label:e.label,roomType:t.room_type,roomCount:t.room_count,originalArea:t.room_area_original_square_metres,adjustedArea:t.room_area_adjusted_square_metres,sourceLabel:e.sourceLabel,sourceCase:t.source_case,priority:t.adjustment_priority,displayScale:1}}select(e){if(!this.rooms.has(e))throw Error(`Interior is not loaded: ${e}`);return this.activeId=e,this.summary}async loadProjectAssets(e=`minecraft-sales`){await this.ensureLoaded(e)}async ensureLoaded(e,t){if(this.rooms.has(e))return;let n=this.pending.get(e);if(n){await n;return}let r=this.loadRoom(nd(e),t);this.pending.set(e,r);try{let t=await r;this.rooms.set(e,t)}finally{this.pending.delete(e)}}getLoadedCount(e){return e?[...this.rooms.values()].filter(t=>t.definition.styleId===e).length:this.rooms.size}getStyleInteriorCount(e){return Ju.filter(t=>t.styleId===e).length}async loadRoom(e,t){let n=Tf(),r=new URL(`assets/interiors/`,document.baseURI),i=new URL(`${e.asset}.export.json`,r),a=new URL(`${e.asset}.glb`,r),[o,s]=await Promise.all([fetch(i),n.loadAsync(a.href,e=>{t&&t(e.total>0?e.loaded/e.total:Math.min(.94,e.loaded/8e6))})]);if(!o.ok)throw Error(`${e.label} metadata returned ${o.status}`);let c=await o.json();Ff(e,c);let l=new In,u=Math.max(c.navigation.bounds.maxX-c.navigation.bounds.minX,c.navigation.bounds.maxZ-c.navigation.bounds.minZ),d=If(l,e.styleId);l.fog=new Fn(d.horizon,Math.max(8,u*1.1),Math.max(20,u*3.2)),Bf(l,e.lightAccent,u,d);let f=s.scene;f.name=`${e.asset}-adjusted-workbench-room`,f.position.set(-c.room_center_blender_xy[0],0,c.room_center_blender_xy[1]),f.traverse(e=>{e instanceof ni&&Hf(e)}),l.add(f);let p=Lu,m=c.navigation.spawn.position,h=c.navigation.spawn.target;return{definition:e,metadata:c,scene:l,obstacles:c.navigation.obstacles,movementArea:{...c.navigation.bounds,floorY:p,minY:p,maxY:p,eyeHeight:p,movementSpeed:2.3,boostSpeed:4.6},spawnPosition:new H(m[0],p,m[2]),spawnTarget:new H(h[0],p-.12,h[2])}}get active(){if(!this.activeId)throw Error(`No active interior`);let e=this.rooms.get(this.activeId);if(!e)throw Error(`Active interior is not loaded: ${this.activeId}`);return e}};function Ff(e,t){if(t.id!==e.id||t.style!==e.styleId||t.room_count<1)throw Error(`${e.label} asset identity does not match its workbench case`);if(t.room_area_adjusted_square_metres<=0||t.mesh_count<=0)throw Error(`${e.label} has invalid generated metadata`)}function If(e,t){let n=zf(t),r=1024,i=document.createElement(`canvas`);i.width=r,i.height=512;let a=i.getContext(`2d`);if(!a)throw Error(`Unable to create interior sky environment`);let o=a.createLinearGradient(0,0,0,512);o.addColorStop(0,new K(n.zenith).getStyle()),o.addColorStop(.42,new K(n.upper).getStyle()),o.addColorStop(.54,new K(n.horizon).getStyle()),o.addColorStop(.64,new K(n.horizon).lerp(new K(n.ground),.35).getStyle()),o.addColorStop(1,new K(n.ground).getStyle()),a.fillStyle=o,a.fillRect(0,0,r,512),n.night&&Lf(a,r,512);let c=r*.72,l=512*(n.night?.28:.36),u=a.createRadialGradient(c,l,0,c,l,n.night?42:86),d=new K(n.sun).getStyle();u.addColorStop(0,d),u.addColorStop(.16,n.night?`rgba(180, 220, 255, 0.72)`:`rgba(255, 244, 205, 0.78)`),u.addColorStop(1,`rgba(255, 255, 255, 0)`),a.fillStyle=u,a.fillRect(0,0,r,512);let f=new aa(i);return f.name=`${t}-interior-sky-environment`,f.mapping=303,f.colorSpace=Ve,f.minFilter=s,f.magFilter=s,f.needsUpdate=!0,e.background=f,e.environment=f,e.backgroundIntensity=n.night?.72:.9,e.environmentIntensity=n.night?.46:.62,n}function Lf(e,t,n){e.save();for(let r=0;r<110;r+=1){let i=Rf(r*2+1)*t,a=Rf(r*2+2)*n*.47,o=.35+Rf(r*3+7)*1.15;e.globalAlpha=.28+Rf(r*5+11)*.55,e.fillStyle=r%5==0?`#b9e8ff`:`#ffffff`,e.beginPath(),e.arc(i,a,o,0,Math.PI*2),e.fill()}e.restore()}function Rf(e){let t=Math.sin(e*12.9898)*43758.5453;return t-Math.floor(t)}function zf(e){return{minecraft:{zenith:5406113,upper:10207439,horizon:15848354,ground:6845289,sun:16773309,night:!1},cyberpunk:{zenith:198166,upper:1055805,horizon:5845590,ground:460818,sun:9363455,night:!0},ghibli:{zenith:7317957,upper:12179667,horizon:16113072,ground:7897964,sun:16770981,night:!1},european:{zenith:7572649,upper:12763835,horizon:15910550,ground:7432543,sun:16768155,night:!1},candy:{zenith:9025753,upper:13946338,horizon:16765903,ground:10126227,sun:16773316,night:!1},modern:{zenith:6586260,upper:11452359,horizon:14801097,ground:6713464,sun:15988201,night:!1},oceanic:{zenith:4030872,upper:9029572,horizon:14736049,ground:4484973,sun:16771237,night:!1}}[e]}function Bf(e,t,n,r){e.add(new uo(r.upper,r.ground,r.night?.92:1.25)),e.add(new jo(r.horizon,r.night?.24:.34));let i=new Ao(16769719,3.1);i.position.set(-n*.45,Math.max(7,n*.75),n*.5),i.castShadow=!0,i.shadow.mapSize.set(1536,1536),i.shadow.camera.left=-n,i.shadow.camera.right=n,i.shadow.camera.top=n,i.shadow.camera.bottom=-n,i.shadow.camera.near=.5,i.shadow.camera.far=Math.max(16,n*3),i.shadow.bias=-5e-4,e.add(i);for(let[r,i,a]of[[0,0,2.8],[n*.22,n*.16,2.05],[-n*.22,-n*.16,2.05]]){let o=new Do(t,a*18,Math.max(7.2,n*.9),1.8);o.position.set(r,2.2,i),e.add(o)}}function Vf(e){return Array.isArray(e)?e:[e]}function Hf(e){e.receiveShadow=!0,e.castShadow=!1;for(let t of Vf(e.material)){if(t.side=2,t instanceof ka){for(let e of[t.map,t.normalMap,t.roughnessMap,t.metalnessMap,t.aoMap])e&&(e.anisotropy=8);t.map&&(t.map.colorSpace=Ve)}t.needsUpdate=!0}}var Uf=document.getElementById(`app`);if(!Uf)throw Error(`Missing #app root`);var Wf=dd(`github-pages`,window.location.search),Gf=Wf??`minecraft`,X=new Ef(Gf),Kf=new Pf,Z=new Co(52,window.innerWidth/window.innerHeight,.08,1400),qf=td(Gf);Wf&&(document.title=`${qf.label} · Interactive Explorer`),Z.position.set(...qf.cameraPosition),Z.lookAt(...qf.cameraTarget),Z.rotation.z=0;var Jf=new bu({antialias:!0,alpha:!1,powerPreference:`high-performance`});Jf.setPixelRatio(Math.min(window.devicePixelRatio,1.7)),Jf.setSize(window.innerWidth,window.innerHeight),Jf.outputColorSpace=Ve,Jf.toneMapping=4,Jf.toneMappingExposure=1.08,Jf.shadowMap.enabled=!0,Jf.shadowMap.type=1;var Yf=new ku(Jf),Xf=new Mu(X.scene,Z),Zf=new Pu(new V(window.innerWidth,window.innerHeight),1.28,.6,.2);Yf.addPass(Xf),Yf.addPass(Zf),Yf.addPass(new ju);var Qf=`city`,$f=!1,ep=!1,tp=null,np=null,rp=0,ip=0,ap=Gf,op=Z.position.clone(),sp=Z.quaternion.clone(),cp=!0,lp=new zo;lp.connect(document);var Q=new _d(Uf,{onEnter:e=>void hp(e),onExit:()=>void gp(),onFocus:_p,onLocate:vp,onScan:yp,onStyleChange:e=>{Wf||bp(e)},onVirtualKey:(e,t)=>$.setVirtualKey(e,t)},{lockedStyleId:Wf});Q.setMode(`city`),Q.canvasHost.appendChild(Jf.domElement),Jf.domElement.setAttribute(`aria-label`,`Interactive 3D city viewport`),Jf.domElement.setAttribute(`tabindex`,`0`);var up=Q.canvasHost.parentElement;if(!up)throw Error(`Missing magnifier host`);var dp=new gd(up,Jf.domElement,Z,X.scene,()=>Jf.toneMappingExposure),$=new ld(Z,Jf.domElement,X.movementArea);$.setEnvironment(X.movementArea,[],!0,(e,t,n,r)=>X.sampleWalkSurface(e,t,n,r)),Q.setFlight(!0);var fp=!1,pp=0;if(new URLSearchParams(window.location.search).has(`capture`)){let e=window,t=(e,t)=>{Z.rotation.set(t,e,0,`YXZ`)};e.__HOLOWORLD_CAPTURE__={prepareCityWalk:(e,n,r,i,a)=>{let o=X.sampleWalkSurface(e,n,0,!0)??0,s=a??X.movementArea.eyeHeight,c={...X.movementArea,eyeHeight:s};return $.setEnvironment(c,[],!0,(e,t,n,r)=>X.sampleWalkSurface(e,t,n,r)),$.setPose(new H(e,o+s,n),new H(e,o+s,n-1)),$.toggleFlight(),t(r,i),Q.setFlight(!1),o},prepareInteriorWalk:(e,n,r,i,a)=>{let o=a??Kf.movementArea.eyeHeight,s={...Kf.movementArea,floorY:o,minY:o,maxY:o,eyeHeight:o};$.setEnvironment(s,Kf.obstacles,!1),$.setPose(new H(e,o,n),new H(e-Math.sin(r),o+Math.sin(i),n-Math.cos(r))),t(r,i)},setLook:t,getLook:()=>({yaw:Z.rotation.y,pitch:Z.rotation.x}),getPosition:()=>({x:Z.position.x,y:Z.position.y,z:Z.position.z}),scoreCityPoints:e=>e.map(e=>X.measureWalkOpenness(e.x,e.z)),tweenLook:(e,t,n)=>Cp(e,t,n),enterCyberpunkInterior:async()=>{await hp(`cyberpunk-lounge`)},enterInteriorCase:async e=>{await hp(e)},exitInteriorScene:async()=>{await gp()},beginOfflineCapture:()=>{fp=!0,pp=0,wp(0,0)},renderOfflineFrame:(e,n,r,i,a,o)=>{t(o??n,r),wp(i,a);let s=Math.max(Math.abs(i),Math.abs(a));$.update(e*s),t(n,r),pp+=e,X.update(pp),Tp(e)}}}window.addEventListener(`keydown`,e=>{if(e.code===`KeyF`&&!e.repeat&&Qf===`city`&&ep&&!$f){let e=$.toggleFlight();dp.setEnabled(e),e||(np=null),Q.setFlight(e)}if(e.code===`KeyE`&&Qf===`city`&&ep){let e=np??tp;e?hp(e.interiorId):Q.showEntryUnavailable()}e.code===`KeyR`&&Qf===`interior`&&gp()}),window.addEventListener(`resize`,xp),Jf.setAnimationLoop(()=>{if(fp)return;lp.update();let e=Math.min(lp.getDelta(),.05);if($.update(e),X.update(lp.getElapsed()),Qf===`city`&&ep){tp=X.findTargetedBuilding(Z);let e=dp.selectionViewport;np=e?X.findMagnifiedBuilding(Z,e.centerNdc,e.halfWidthNdc,e.halfHeightNdc):null;let t=np??tp;X.setSelected(t?.id??null),dp.setTarget(np?.roomLabel??null),Q.setBuildingSelected(t?.id??null),Q.setNearbyBuilding(t,np!==null)}Q.placeBuildingPins(Z,X.buildings,Qf===`city`&&ep,(np??tp)?.id??null,performance.now()<rp),Tp(e)}),mp();async function mp(){try{Q.setProgress(.03,`Preparing WebGL renderer`),await Promise.all([X.load((e,t)=>Q.setProgress(.06+e*.88,t)),Kf.loadProjectAssets(qf.buildings[0]?.interiorId)]),ep=!0,Q.setProgress(1,`City ready`),Q.finishLoading(),Q.toggleHelp(!0)}catch(e){console.error(e);let t=e instanceof Error?e.message:`Unknown loading error`;Q.showError(`Unable to load the scene: ${t}`)}}async function hp(e){if(Qf!==`city`||$f||!ep)return;$f=!0,np=null,$.exitPointerLock(),$.setEnabled(!1),Q.setRuntimeStatus(`Loading adjusted workbench interior...`);try{await Kf.ensureLoaded(e,e=>{Q.setRuntimeStatus(`Loading interior · ${String(Math.round(e*100)).padStart(2,`0`)}%`)})}catch(e){console.error(e),$.setEnabled(!0),$f=!1,Q.setRuntimeStatus(`Interior load failed; city remains active`);return}op=Z.position.clone(),sp=Z.quaternion.clone(),cp=$.isFlightEnabled;let t=Q.transition();await Sp(260);let n=Kf.select(e);Qf=`interior`,Z.fov=52,Z.updateProjectionMatrix(),Jf.toneMappingExposure=1.14,Q.setInterior(n),Q.setMode(Qf),dp.setEnabled(!1),$.setEnvironment(Kf.movementArea,Kf.obstacles,!1),$.setPose(Kf.spawnPosition,Kf.spawnTarget),Q.setFlight(!1),await t,$.setEnabled(!0),$f=!1}async function gp(){if(Qf!==`interior`||$f)return;$f=!0,$.exitPointerLock(),$.setEnabled(!1);let e=Q.transition();await Sp(260),Qf=`city`,Z.fov=52,Z.updateProjectionMatrix(),Jf.toneMappingExposure=1.08,Q.setMode(Qf),Z.position.copy(op),Z.quaternion.copy(sp),Z.rotation.order=`YXZ`,$.setEnvironment(X.movementArea,[],cp,(e,t,n,r)=>X.sampleWalkSurface(e,t,n,r)),dp.setEnabled(cp),Q.setFlight(cp),await e,$.setEnabled(!0),$f=!1}function _p(){if(Qf!==`city`||!ep)return;let e=X.buildings;if(e.length===0)return;let t=e[ip%e.length];ip=(ip+1)%e.length,vp(t.id)}function vp(e){if(Qf!==`city`||!ep)return;let t=X.buildings.find(t=>t.id===e);if(!t)return;$.isFlightEnabled||($.toggleFlight(),dp.setEnabled(!0),Q.setFlight(!0));let n=X.getFocusPose(t.id);$.setPose(n.position,n.target),tp=t,X.setSelected(t.id),Q.setBuildingSelected(t.id)}function yp(){Qf!==`city`||!ep||(rp=performance.now()+3e3,Q.showEntranceScan(X.buildings.length))}async function bp(e){if(Qf!==`city`||$f||e===ap)return;$f=!0,ep=!1,tp=null,np=null,dp.setTarget(null),X.setSelected(null),Q.setBuildingSelected(null),$.exitPointerLock(),$.setEnabled(!1);let t=Q.transition();await Sp(260);try{await X.selectStyle(e,(e,t)=>{Q.setRuntimeStatus(`${t} · ${String(Math.round(e*100)).padStart(2,`0`)}%`)}),ap=e,Jf.toneMappingExposure=1.08,ip=0,rp=0,Q.setCityStyle(X.style),$.setEnvironment(X.movementArea,[],!0,(e,t,n,r)=>X.sampleWalkSurface(e,t,n,r)),$.setPose(new H(...X.style.cameraPosition),new H(...X.style.cameraTarget)),op=Z.position.clone(),sp=Z.quaternion.clone(),Q.setFlight(!0),ep=!0}catch(t){console.error(t),Q.setRuntimeStatus(`Unable to load ${td(e).shortLabel} city`)}finally{await t,$.setEnabled(!0),$f=!1}}function xp(){Z.aspect=window.innerWidth/window.innerHeight,Z.updateProjectionMatrix();let e=Math.min(window.devicePixelRatio,1.7);Jf.setPixelRatio(e),Jf.setSize(window.innerWidth,window.innerHeight),Yf.setPixelRatio(e),Yf.setSize(window.innerWidth,window.innerHeight)}function Sp(e){return new Promise(t=>window.setTimeout(t,e))}function Cp(e,t,n){let r=Z.rotation.y,i=Z.rotation.x,a=performance.now();return new Promise(o=>{let s=c=>{let l=Math.min(1,(c-a)/n),u=l*l*(3-2*l);Z.rotation.set(i+(t-i)*u,r+(e-r)*u,0,`YXZ`),l<1?requestAnimationFrame(s):o()};requestAnimationFrame(s)})}function wp(e,t){$.setVirtualKey(`KeyW`,e>0),$.setVirtualKey(`KeyS`,e<0),$.setVirtualKey(`KeyD`,t>0),$.setVirtualKey(`KeyA`,t<0)}function Tp(e){Qf===`city`&&ap===`cyberpunk`?Yf.render(e):Jf.render(Qf===`city`?X.scene:Kf.scene,Z),dp.render()}